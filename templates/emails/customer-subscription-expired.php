...
<?php /* translators: %s: Order number */ ?>
    <p><?php printf( esc_html__( 'We would like to inform you that your subscription #%s has expired.', 'subre-product-subscription-for-woo' ), esc_html( $subscription->get_order_number() ) ); ?></p>
