...
echo sprintf( esc_html__( 'Notification to let you know — subscription #%1$s belonging to %2$s has expired.', 'subre-product-subscription-for-woo' ), esc_html( $subscription->get_order_number() ), esc_html( $subscription->get_formatted_billing_full_name() ) ) . "\n\n";
