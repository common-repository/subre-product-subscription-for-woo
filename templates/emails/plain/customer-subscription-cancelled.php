...
echo sprintf( esc_html__( 'We would like to inform you that your subscription #%s is now cancelled.', 'subre-product-subscription-for-woo' ), esc_html( $subscription->get_order_number() ) ) . "\n\n";
